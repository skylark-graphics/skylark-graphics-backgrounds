...
define('skylark-graphics-brushes/linear-gradient-brush',[
	"skylark-langx/langx",
	"./brushes",
	"./gradient-brush"
...
define('skylark-graphics-backgrounds/background-attachment',[
	"skylark-langx/langx",
	"./backgrounds"
...
define('skylark-graphics-backgrounds/background-origin',[
	"skylark-langx/langx",
	"./backgrounds"
],function(langx,backgrounds) {
...
define('skylark-graphics-backgrounds/background-position',[
	"skylark-langx/langx",
	"./backgrounds"
],function(langx,backgrounds) {
...
define('skylark-graphics-backgrounds/background-size-type',[
	"skylark-langx/langx",
	"./backgrounds"
],function(langx,backgrounds) {
...
define('skylark-graphics-backgrounds/background-size',[
	"skylark-langx/langx",
	"./backgrounds",
...
define('skylark-graphics-backgrounds/background',[
	...
	"skylark-graphics-brushes/solid-color-brush",
	"skylark-graphics-brushes/image-brush",
	"skylark-graphics-brushes/linear-gradient-brush",
	"skylark-graphics-brushes/radial-gradient-brush",
	"skylark-graphics-brushes/tile-repeate-mode",
	"./backgrounds",
